    ...
    <div>
      <div className="flex flex-col gap-6 py-28 px-3 max-w-6xl mx-auto">
        ...
        <div className='text-gray-400 text-xs sm:text-sm'>
          Tenant is the "PLACE" you were looking for...<br />
          We have a wide range of properties you can choose from.
        </div>
      ...
      <Swiper navigation>
        {offerListings && offerListings.length > 0 && offerListings.map((listing) => (
          <SwiperSlide>
            <div className="h-[1000px]" key={listing._id} style={{ background: `url(${listing.imageUrls[0]}) center no-repeat`, backgroundSize: 'cover' }}></div>
          </SwiperSlide>
        ))}
      </Swiper>
