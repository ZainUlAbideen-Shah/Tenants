        ...
        <>
            {landlord && (
                <div className="flex flex-col gap-2">
                    ...
                    <textarea className="w-full border p-3 rounded-lg" placeholder='Enter your query...' name="message" id="message" rows='2' value={message} onChange={handleChange}></textarea>
